...
package com.svoflee.spartacus.test.groups;
...
/**
 * GroupsTestRunner 是实现TestNG Groups分组执行用例功能的TestRunner.
...
public class GroupsTestRunner extends BlockJUnit4ClassRunner {
    ...
    /**
     * 判断测试类是否符合分组要求. 如果至少含有一个符合Groups定义的测试方法时返回true.
     */
    ...
    /**
     * 判断测试方法是否符合Groups要求. 如果@Groups符合定义或Groups定义为ALL或方法上无@Groups定义返回true.
     */
    ...
    /**
     * 从环境变量读取test.groups定义, 多个group用逗号分隔. eg. java -Dtest.groups=Mini,Major
     * 如果无定义则返回ALL.
     */
